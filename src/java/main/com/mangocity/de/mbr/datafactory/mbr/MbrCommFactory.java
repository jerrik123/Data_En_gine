...
public class MbrCommFactory {
	...
	public Map<String,Object> queryMbrByMbrId(EngineBean pb) throws ExceptionAbstract {
		...
		if(isBlankIncludeNull(String.valueOf(mbrMap.get("stus")))
				||(!ConstantArgs.STATUS_ACTIVE.equals(String.valueOf(mbrMap.get("stus"))) && !"1".equals(String.valueOf(mbrMap.get("stus"))))){
	...
	public Map<String,Object> isCrmMbr(EngineBean pb) throws ExceptionAbstract {
		...
		if(String.valueOf(mbrMap.get("attribute")).equals("1")){
			...
			throw new BusinessException(this, ErrorConstant.Mbr.ERROR_MBR_IS_NOT_CRM_MBR_30012, "该会员不是集团会员");
		}
	 ...
	 * @return
	 */
	public int updateMbrAttribute(EngineBean pb) throws ExceptionAbstract {
		log.info("MbrCommFactory updateMbrAttribute begin()...param: " + pb.getHeadMap());
		return SqlUtil.getInstance().updateOne("updateMbrAttribute", pb.getHeadMap());
